...
img3_path = os.path.join(os.path.dirname(__file__), r'.\data\\7_23_nathans_pool\\FSL-01F_Fred\\P7130401.ORF')                
...
img2_data, img2_visual = config2.applyToImage(img1_path)
