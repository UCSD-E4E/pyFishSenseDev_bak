...
class LaserDetector:
    ...
    def _get_line(self, one: np.ndarray, two: np.ndarray) -> Tuple[Tuple[int, int], Tuple[int, int]]:
    ...
    def _get_masked_image_matrix(self, img: np.ndarray) -> Tuple[np.ndarray | None, np.ndarray | None]:
    ...
    def _get_tiles(self, img: np.ndarray, coordinates: np.ndarray) -> Tuple[np.ndarray, np.ndarray]:
